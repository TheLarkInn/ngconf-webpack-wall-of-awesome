...
/***/ function(module, exports, __webpack_require__) {
	...
	var browser_2 = __webpack_require__(315);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var app_state_service_ts_1 = __webpack_require__(91);
	var task_model_ts_1 = __webpack_require__(312);
	var taskbox_component_ts_1 = __webpack_require__(313);
	var utils_ts_1 = __webpack_require__(314);
	var App = (function () {
	    function App(model, appState) {
	        var _this = this;
	        this.model = model;
	        this.appState = appState;
	        model.tasksUpdated.subscribe(function (tasks) {
	            _this.tasks = utils_ts_1.sortedByVotes(tasks);
	        });
	    }
	    App.prototype.voteForTask = function (task, vote) {
	        task.votes += vote;
	    ...
	    App = __decorate([
	        core_1.Component({
	            selector: 'app',
	            pipes: [],
	            providers: [task_model_ts_1.TaskModel],
	            directives: [taskbox_component_ts_1.TaskBox],
	        ...
	        __metadata('design:paramtypes', [task_model_ts_1.TaskModel, app_state_service_ts_1.AppState])
	    ], App);
	    return App;
	}());
	exports.App = App;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var app_state_service_ts_2 = __webpack_require__(91);
	/*
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(5);
	var app_state_service_ts_1 = __webpack_require__(91);
	var Firebase = __webpack_require__(538);
	var _ = __webpack_require__(303);
	var TaskModel = (function () {
	    function TaskModel(appState) {
	        var _this = this;
	        this.appState = appState;
	        ...
	        this.fbRef.on('value', function (snapshot) {
	            var tasks = _.values(snapshot.val());
	            _this.tasksUpdated.emit(tasks);
	        });
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TaskBox = (function () {
	    ...
	    TaskBox.prototype.upvote = function () {
	        this.vote.emit(1);
	    };
	    TaskBox.prototype.downvote = function () {
	        this.vote.emit(-1);
	    };
	    __decorate([
	        core_1.Input(), 
	        __metadata('design:type', Object)
	    ], TaskBox.prototype, "task", void 0);
	    __decorate([
	        core_1.Output(), 
	        __metadata('design:type', Object)
	    ], TaskBox.prototype, "vote", void 0);
	    TaskBox = __decorate([
	        core_1.Component({
	            selector: 'task-box',
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var _ = __webpack_require__(303);
	function sortedByVotes(task) {
	    return _.orderBy(task, ['votes'], ['desc']);
	}
	exports.sortedByVotes = sortedByVotes;
...
/***/ function(module, exports) {
	...
	module.exports = "body {\n\tbackground: #f3f5f6;\n}\n\na {\n\ttext-decoration: none;\n\tcolor: #0400c4\n}\n\na:hover {\n\tcolor: hotpink;\n}\n\n.ng-cloak {\n\tdisplay: none;\n}\n\n.topcat-box {\n\tdisplay: inline-block;\n\theight: 270px;\n\twidth: 250px;\n\tposition: relative;\n\ttext-align: center;\n\tmargin: 12px;\n\tvertical-align: baseline;\n\toverflow: hidden;\n\tborder-radius: 4px;\n\tbox-shadow: 2px 2px 4px gray;\n}\n\nimg {\n\tposition: absolute;\n\tbottom: 0px;\n\tright: 0px;\n\tmin-width: 100%;\n\tmin-height: 100%;\n\twidth: auto;\n\theight: auto;\n\tz-index: -1000;\n\toverflow: hidden;\n}\n\n.topcat-rating-controls {\n\tposition: absolute;\n\tbottom: 0;\n\tleft: 0;\n\tright: 0;\n\tpadding: 8px 16px;\n\ttext-align: center;\n\tfont-size: 24px;\n\tbackground: rgba(255, 255, 255, 0.9);\n}\n\n.topcat-rating-controls a {\n\tfloat: left;\n\tmargin-right: 16px;\n}\n\n.topcat-rating-controls .fa-heart {\n\tcolor: #dc0000;\n}\n\n.topcat-votes {\n\tfloat: right;\n}\n.topcat-votes i {\n\tmargin-right: 8px;\n}\n"
